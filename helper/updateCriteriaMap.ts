...
export const updateCriteriaMap = async ({
  ...
  const criteriaMap: Unlockables = {
    ...
    small_2: {
      ...
      message: "Score 9 or lower on a small board to unlock this color scheme",
      progress: bestSmallScore ? `Current best: ${bestSmallScore}` : "n/a",
    },
    small_3: {
      locked:
        (bestSmallScore === null || bestSmallScore > 7) &&
        savedCriteriaMap["small_3"]?.locked !== false,
      message: "Score 7 or lower on a small board to unlock this color scheme",
      progress: bestSmallScore ? `Current best: ${bestSmallScore}` : "n/a",
    },
    medium_1: {
      locked:
    ...
    winstreak_1: {
      locked:
        (bestWinStreak === null || bestWinStreak < 2) &&
        savedCriteriaMap["winstreak_1"]?.locked !== false,
      message: "Win 2 matches in a row in player vs player",
      progress:
        bestWinStreak === null ? "n/a" : `Current best: ${bestWinStreak}`,
    },
    winstreak_2: {
      locked:
        (bestWinStreak === null || bestWinStreak < 4) &&
        savedCriteriaMap["winstreak_2"]?.locked !== false,
      message: "Win 4 matches in a row in player vs player",
      progress:
        bestWinStreak === null ? "n/a" : `Current best: ${bestWinStreak}`,
    },
    winstreak_3: {
